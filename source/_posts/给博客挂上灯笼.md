...
本教程直接引入 [@韩小韩](https://www.vvhan.com) 的 [API](https://api.vvhan.com) 接口，以便实现最简化调用。如若担心引用接口失效，可以参考 [@Xlenco](https://blog.xlenco.top) 的 [这篇](https://xlenco.eu.org/posts/ada5.html) 文章以获得帮助。
